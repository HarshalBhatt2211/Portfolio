...
import xyz from '../img/A-Detailed-Understanding-Of-Takt-Time-Cycle-Time-And-Lead-Time.webp';
import ghi from '../img/Design and Fabrication of a Practical Model of an Airplane Landing Gear.pdf';
import qrx from '../img/Design and Fabrication of a Remote controlled Foldable Electric Skateboard.pdf';
import hij from '../img/Time cycle analysis and reduction of time of every station to station of EV shop and reduce manpower.pdf';
import klm from '../img/Focussing on using the TDS tool for ECU flashing.pdf';
